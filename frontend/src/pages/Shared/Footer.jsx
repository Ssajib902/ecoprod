...
const Footer = () => {
    return (
        <>
            <footer>
                {/* Main Footer Section */}
                <div className="footer bg-neutral text-neutral-content p-10 flex flex-col md:flex-row justify-between">
                    {/* Logo and Description */}
                    <aside className="flex flex-col items-start mb-6 md:mb-0">
                        <Link to='/' className="flex items-center mb-4">
                            <img
                                className="w-12 h-12 mr-3"
                                src="https://i.ibb.co/995gFSS/Ecoprod-PNG.png"
                                alt="EcoProd Logo"
                            />
                            <span className="text-xl font-bold">EcoProd</span>
                        </Link>
                        <p>
                            Providing best services since 2024
                        </p>
                    </aside>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                                <svg
                                    ...
                                    height="24"
                                    viewBox="0 0 24 24"
                                    className="fill-current hover:text-blue-500 transition-colors duration-200">
                            ...
                            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                                <svg
                                    ...
                                    height="24"
                                    viewBox="0 0 24 24"
                                    className="fill-current hover:text-red-600 transition-colors duration-200">
                                    <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0
                                             ...
                                             3.897-.266 4.356-2.62 4.385-8.816
                                             -.029-6.185-.484-8.549-4.385-8.816
                                             zm-10.615 12.816v-8l8 3.993-8 4.007z">
                                    </path>
                                </svg>
                            </a>

                            {/* Facebook */}
                            <a href="https://www.facebook.com/mahsajib.15/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    className="fill-current hover:text-blue-700 transition-colors duration-200">
                ...
                <div className="footer footer-center bg-base-300 text-base-content p-4">
                    <p>Copyright © {new Date().getFullYear()} - All rights reserved by EcoProd.</p>
                </div>
            </footer>
        </>
    );
